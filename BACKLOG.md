...
- [ ] `uqb6y` Op-only CLI: drop builtin strand commands and the op prefix, root-level op dispatch via invoke envelope, mill absorbs init/weaver lifecycle, shipped surface moves to skein.spools.batteries; see devflow/rfcs/2026-07-04-op-only-cli.md (RFC-019)
