...
- The in-tree feature (`rrvnn`) deletes the 7 installers, converts the 28 call sites, and regenerates the affected docs (7 `spools/*.api.md`, prose in `guild.md` and `unsafe-text-search.md`).
