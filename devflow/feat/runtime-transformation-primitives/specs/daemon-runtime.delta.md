...
- **SPEC-004-D002.C4:** Daemon semantic operations expose set-oriented task primitives needed by trusted runtime libraries: query ids, batch task hydration by ids, parent-of ancestor/root traversal, and parent-of subgraph expansion.
...
- **SPEC-004-D002.C9:** Blessed runtime transformation helpers live in source-visible `atom.*.alpha` namespaces and build on the runtime library workspace model.
