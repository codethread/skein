...
- **TASK-Olr-024.MI1:** Provide a small explicit API to construct a runtime-attached owner registry with a domain validator, replace/remove one complete owner partition, inspect an immutable snapshot/effective view, and explain shadowed/override state.
...
- **TASK-Olr-024.DW1:** External-style tests build two independent registries in two unpublished runtimes and prove no cross-talk, all override/deletion transitions, malformed validator failures, and snapshot concurrency.
