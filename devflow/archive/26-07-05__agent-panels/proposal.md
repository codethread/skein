...
- **PROP-Pnl-001.Q5:** Does council-classic (one long-lived run per member, in-run polling) survive as a preset variant for deliberation-quality comparison, or is it deleted outright (TEN-000@1)?
