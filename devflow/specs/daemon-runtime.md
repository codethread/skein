...
- **SPEC-004.C26:** The JSON socket operation allowlist is limited to public CLI behavior: `init`, `add`, `update`, `supersede`, `show`, `burn`, `list`, `ready`, `list-query`, `ready-query`, `weave`, `pattern-explain`, `status`, and `stop`.
