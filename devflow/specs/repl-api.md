...
**Document ID:** `SPEC-003` **Status:** Implemented **Last Updated:** 2026-07-15 **Code:** `src/skein/repl.clj`, `src/skein/api/*.alpha`, `src/skein/userland/alpha.clj`, `src/skein/test`
