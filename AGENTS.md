...
- [Brief/Guide Primitives](./spools/brief.md) (classpath-shipped spool: per-run contracts and durable authoring guides as closed-key data over one `brief->prompt` renderer and named clause blocks, behind the fetch-only `brief` op)
